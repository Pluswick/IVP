...
def process_frame(frame):
    ...
    #cv2.imshow("2. Cropped Face", face_img)
    ...
    #cv2.imshow("3. Emotion Input", face_resized)
    ...
    # 5. 성별/연령 분류 (CPU)
    #  저장된 얼굴이 필요하면 파일로도 남길 수 있지만, 여기선 메모리로 처리
